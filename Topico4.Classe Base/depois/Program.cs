...
namespace Topico4
{
    ...
    //A classe base deve vir antes das interfaces
    ...
    //fazendo uma herança com :
    //com o sealed, não é possível derivar ou herdar essa classe
    sealed class Cliente : Pessoa
    {
        public DateTime? DataUltimaCompra { get; set; }
        public decimal? ValorUltimaCompra { get; set; }// o ? quer dizer que a variável também aceita nulos
    ...
    //todas as classes que herdam a classe pessoas tem esses atributos
    //com a classe abstrata -abstract -, não é possível criar uma nova instancia da classe Pessoa
